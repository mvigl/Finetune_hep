...
ax.plot(tpr_common, 1/fpr_CMSXbb_mean, lw=0.8, label=f'CMS(old)Xbb AUC = {auc_CMSXbb_mean:.4f}', color='r')
ax.set_ylabel(r'QCD-jet rejection')
ax.semilogy()
ax.set_ylim(1,10000)
ax.set_xlim(0.4,1)
ax.grid(True)
...
ax.grid(True)
ax.set_xlabel(r'Hbb-jet efficiency',loc="right")
