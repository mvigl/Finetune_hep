...
ax.plot(tpr_common, 1/fpr_ParTevent_mean, lw=0.8, label=f'EndToEnd AUC = {auc_ParTevent_mean:.4f}',color='b')
...
ax.plot(tpr_common, 1/fpr_mlpHlXbb_mean, lw=0.8, label=f'mlpHlXbb AUC = {auc_mlpHlXbb_mean:.4f}',color='r')
