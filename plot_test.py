...
ax.plot(tpr_common, 1/fpr_ParTevent_mean, lw=0.8, label=f'EndToEnd_mean AUC = {auc_ParTevent_mean} +/- {auc_ParTevent_std}',color='b')
ax.fill_between(tpr_common, (1/fpr_ParTevent_mean-1/fpr_ParTevent_std), (1/fpr_ParTevent_mean+1/fpr_ParTevent_std),color='b',alpha=0.2)
ax.plot(tpr_common, 1/fpr_mlpHlXbb_mean, lw=0.8, label=f'mlpHlXbb_mean AUC = {auc_mlpHlXbb_mean} +/- {auc_mlpHlXbb_std}',color='r')
ax.fill_between(tpr_common, (1/fpr_mlpHlXbb_mean-1/fpr_mlpHlXbb_std), (1/fpr_mlpHlXbb_mean+1/fpr_mlpHlXbb_std),color='r',alpha=0.2)
