...
for size in sizes:
    ...
    ymlpHlXbb.append(yi)
    targetmlpHlXbb.append(target)  


Data = h5py.File(f'../../Finetune_hep/models/subsets/test_{name}.h5', 'w')
Data.create_dataset('ParTevent_evt_score', data=yParT)
Data.create_dataset('ParTevent_evt_label', data=targetParT,dtype='i4')
Data.create_dataset('mlpHlXbb_evt_score', data=ymlpHlXbb)
Data.create_dataset('mlpHlXbb_evt_label', data=targetmlpHlXbb,dtype='i4')
Data.close()     
