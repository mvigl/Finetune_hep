...
if args.head: model = models.head(args.config,save_representaions=args.save_representaions,for_inference=True)
...
if __name__ == '__main__':    
    ...
    print(model)
    model.to(device)
    if args.head: models.save_rep_head(model,device,args.data,args.out,args.repDim,args.Xbb,args.use_hlf,args.scaler_path)
