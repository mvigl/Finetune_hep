...
parser.add_argument('--out', help='message',default='/raven/u/mvigl/public/run/Scratch_Xbb_hl/scores')
...
parser.add_argument('--checkpoint',  help='training-checkpoint',default='/raven/u/mvigl/public/run/Scratch_Xbb_hl/models/Scratch_Xbb_hl_lr0.001_bs256_subset0.1.pt')
