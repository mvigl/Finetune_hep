...
parser.add_argument('--data', help='data',default='/u/mvigl/Finetune_hep_dir/config/train_list.txt')
parser.add_argument('--data_val', help='data_val',default='/u/mvigl/Finetune_hep_dir/config/val_list.txt')
