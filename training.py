...
parser.add_argument('--data', help='data',default='/home/iwsatlas1/mavigl/public/Finetune_hep/config/train_list.txt')
parser.add_argument('--data_val', help='data_val',default='/home/iwsatlas1/mavigl/public/Finetune_hep/config/val_list.txt')
